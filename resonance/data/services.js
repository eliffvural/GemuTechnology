...
export const services2 = [
  {
    ...
    text: "Yeni bir fikir, mevcut bir iş ihtiyacı ya da büyüme hedefi için doğru ürün kapsamını birlikte netleştiririz. Öncelikleri sadeleştirir, uygulanabilir bir yol haritası çıkarırız.",
    categories: ["İhtiyaç analizi", "Yol haritası", "Önceliklendirme"],
    outcome: "Fikirden uygulanabilir plana",
    delay: "0s",
  ...
  },
  {
    ...
    title: "İş Süreci Tasarımı",
    text: "Dağınık iş akışlarını, ekiplerin daha kolay takip edebileceği düzenli süreçlere dönüştürürüz. Tekrarlanan işleri azaltır, karar alma ve operasyon takibini kolaylaştırırız.",
    categories: ["Süreç analizi", "Ekip uyumu", "Operasyon takibi"],
    outcome: "Daha düzenli çalışma akışı",
    delay: "0.15s",
  ...
  },
  {
    ...
    title: "Akıllı Otomasyon Danışmanlığı",
    text: "Zaman alan işleri ve manuel kontrolleri belirleyip daha verimli çalışma modelleri kurgularız. Amaç, ekibin tekrar eden işler yerine değer üreten işlere odaklanmasıdır.",
    categories: ["Zaman tasarrufu", "Verimlilik", "Karar desteği"],
    outcome: "Daha az tekrar, daha çok odak",
    delay: "0.3s",
  ...
  },
  {
    ...
    text: "Yayına alınan ürünlerin düzenli gelişmesi, bakımının kolaylaşması ve büyüme dönemlerine hazır kalması için uzun vadeli çalışma planı oluştururuz.",
    categories: ["Sürekli iyileştirme", "Bakım planı", "Büyüme hazırlığı"],
    outcome: "Bugün çalışan, yarın büyüyen yapı",
    delay: "0.3s",
