...
export const services2 = [
  {
    ...
    text: "Next.js ve React ekosistemiyle SEO uyumlu, yüksek performanslı ve sürdürülebilir kurumsal web platformları tasarlıyor; marka deneyimini ölçülebilir iş sonucuna dönüştürüyoruz.",
    categories: [
      "Next.js App Router",
  ...
  },
  {
    ...
    text: "Node.js ile servis katmanını, Supabase ve PostgreSQL ile veri katmanını güçlendirerek güvenli, gerçek zamanlı ve yüksek dayanıklılığa sahip API altyapıları kuruyoruz.",
  ...
  },
  {
    ...
    text: "Gemini/GPT tabanlı LLM entegrasyonlarını Computer Vision çözümleriyle birleştirerek karar destek, otomasyon ve verimlilik odaklı akıllı iş sistemleri geliştiriyoruz.",
    categories: [
      "LLM Entegrasyonları",
      "Computer Vision",
      "Akıllı İş Akışları",
  ...
  },
  {
    ...
    text: "Cross-platform geliştirme yaklaşımıyla tek kod tabanından iOS ve Android için tutarlı, hızlı ve yüksek kaliteli mobil ürünler sunuyoruz.",
