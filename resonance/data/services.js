...
export const services2 = [
  {
    ...
    text: "Next.js ve React ekosistemiyle SEO uyumlu, yuksek performansli ve surdurulebilir kurumsal web platformlari tasarliyor; marka deneyimini olculebilir is sonucuna donusturuyoruz.",
    categories: [
      "Next.js App Router",
      "React Bilesen Mimarisi",
  ...
  },
  {
    ...
    title: "Backend ve Veri Yonetimi",
    text: "Node.js ile servis katmanini, Supabase ve PostgreSQL ile veri katmanini guclendirerek guvenli, gercek zamanli ve yuksek dayanikliliga sahip API altyapilari kuruyoruz.",
    categories: ["Node.js API Tasarimi", "Supabase Auth/RLS", "Gercek Zamanli Veri"],
    delay: "0.15s",
  ...
  },
  {
    ...
    text: "Gemini/GPT tabanli LLM entegrasyonlarini Computer Vision cozumleriyle birlestirerek karar destek, otomasyon ve verimlilik odakli akilli is sistemleri gelistiriyoruz.",
    categories: [
      "LLM Entegrasyonlari",
      "Computer Vision",
      "Akilli Is Akislari",
  ...
  },
  {
    ...
    text: "Cross-platform gelistirme yaklasimiyla tek kod tabanindan iOS ve Android icin tutarli, hizli ve yuksek kaliteli mobil urunler sunuyoruz.",
    categories: ["React Native", "Tek Kod Tabanli Gelistirme", "Yuksek Performansli UI"],
    delay: "0.3s",
