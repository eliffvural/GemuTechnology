...
export const services2 = [
  {
    ...
    text: "Next.js ve React ekosistemiyle SEO uyumlu, yüksek performanslı ve sürdürülebilir kurumsal web platformları tasarlıyoruz. İçerik yönetimi, çok dilli yapı, analitik ve dönüşüm odaklı arayüzleri tek mimaride topluyoruz.",
    categories: [
      "Next.js App Router",
  ...
  },
  {
    ...
    text: "Node.js ile servis katmanını, Supabase ve PostgreSQL ile veri katmanını güçlendirerek güvenli, gerçek zamanlı ve yüksek dayanıklılığa sahip API altyapıları kuruyoruz. Yetkilendirme, denetim izi ve entegrasyon ihtiyaçlarını baştan tasarlıyoruz.",
    categories: ["Node.js API Tasarımı", "Supabase Auth/RLS", "Gerçek Zamanlı Veri"],
    delay: "0.15s",
  ...
  },
  {
    ...
    text: "Gemini/GPT tabanlı LLM entegrasyonlarını Computer Vision çözümleriyle birleştirerek karar destek, otomasyon ve verimlilik odaklı akıllı iş sistemleri geliştiriyoruz. Tekrarlı operasyonları akıllı iş akışlarına dönüştürüyoruz.",
    categories: [
      "LLM Entegrasyonları",
      "Computer Vision",
      "Akıllı İş Akışları",
  ...
  },
  {
    ...
    text: "Cross-platform geliştirme yaklaşımıyla tek kod tabanından iOS ve Android için tutarlı, hızlı ve yüksek kaliteli mobil ürünler sunuyoruz. Offline kullanım, bildirim, rol bazlı erişim ve API entegrasyonlarını üretim kalitesinde kurguluyoruz.",
    categories: ["React Native", "Tek Kod Tabanlı Geliştirme", "Yüksek Performanslı UI"],
    delay: "0.3s",
