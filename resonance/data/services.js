...
export const services2 = [
  {
    ...
    text: "Kurumsal web siteleri, müşteri portalları, içerik yönetimi ve iş süreçlerinize özel web uygulamaları geliştiririz. Keşif ve kapsam çalışmasını yazılım üretim sürecinin ilk adımı olarak ele alırız.",
    categories: ["Kurumsal web", "Portal", "İçerik yönetimi"],
    outcome: "Yayına hazır web ürünü",
    delay: "0s",
  ...
  },
  {
    ...
    text: "Operasyon, onay, takip, raporlama ve ekip içi iş akışlarını tek ekranda toplayan kuruma özel yazılımlar geliştiririz. Amaç, günlük işleri sadeleştiren ve büyümeye uyum sağlayan bir ürün yapısı kurmaktır.",
    categories: ["İş akışı", "Yönetim paneli", "Raporlama"],
    outcome: "Daha düzenli operasyon",
    delay: "0.15s",
  ...
  },
  {
    ...
    text: "Doküman işleme, destek akışları, raporlama, karar destek ve iş takip süreçlerine AI ve otomasyon katmanı ekleriz. Doğru kullanım senaryosunu belirleyip bunu çalışan ürün akışına entegre ederiz.",
    categories: ["AI katmanı", "Otomasyon", "Raporlama"],
    outcome: "Ürüne entegre akıllı iş akışı",
    delay: "0.3s",
  ...
  },
  {
    ...
    text: "Saha ekipleri, müşteri deneyimi, üyelik sistemleri ve bildirim ihtiyaçları için mobil uygulamalar geliştiririz. Web paneli, kullanıcı akışları ve operasyon ihtiyaçlarıyla uyumlu çalışan tutarlı ürün yapıları kurarız.",
    categories: ["Mobil ürün", "Bildirim", "Üyelik"],
    outcome: "Web ile uyumlu mobil deneyim",
    delay: "0.3s",
