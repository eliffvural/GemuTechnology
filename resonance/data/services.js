...
export const services2 = [
  ...
  },
  {
    ...
    title: "Backend ve Veri Yönetimi",
    text: "Güvenli API servisleri, kullanıcı rolleri, veri modeli, entegrasyonlar ve yönetim panelleri geliştiririz. Sistemin büyüdükçe düzenli kalması için backend mimarisini en baştan planlarız.",
    categories: ["API servisleri", "Veri modeli", "Entegrasyon"],
    outcome: "Güvenilir servis altyapısı",
    delay: "0.15s",
  ...
  },
  {
    ...
    text: "Saha ekipleri, müşteri deneyimi, üyelik sistemleri ve bildirim ihtiyaçları için mobil uygulamalar geliştiririz. Web ve backend katmanlarıyla birlikte çalışan tutarlı ürün yapıları kurarız.",
