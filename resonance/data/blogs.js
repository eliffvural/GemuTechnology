...
export const blogs3 = [
  {
    ...
    alt: "Gemu Technology görseli",
    author: "Gemu Technology",
    date: "6 June",
    title: "Natura Insects Series: Crafting Insects Made by Flowers",
    delay: "",
  },
...
export const blogs6 = [
  {
    ...
    authorImgAlt: "Gemu Technology görseli",
    author: "Adam Smith",
    date: "August 3",
    delay: "0s",
  },
...
export const blogs9 = [
  {
    ...
    altText: "Gemu Technology görseli",
...
export const blogs16 = [
  {
    ...
    title: "Kurumsal Web Projelerinde Başarılı Başlangıç Kriterleri",
    date: "12 Nisan 2026",
    category: "Yazılım",
    colorClass: "color-primary-1",
    desc: "İş hedefi, kullanıcı akışı ve içerik yapısı netleştiğinde kurumsal web projeleri daha hızlı ve sağlıklı ilerler.",
  },
  {
    id: 78,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-2-gemu.png",
    title: "AI ve Otomasyon Kurum İçinde Nerede Değer Üretir?",
    date: "26 Nisan 2026",
    category: "AI",
    colorClass: "color-primary-2",
    desc: "Tekrarlı destek, doküman işleme, raporlama ve karar destek süreçlerinde AI katmanı ölçülebilir fayda sağlar.",
  },
  {
    id: 79,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-3.jpg",
    title: "Kurumsal Süreç Yazılımlarında Ölçeklenebilirlik",
    date: "8 Mayıs 2026",
    category: "Mimari",
    colorClass: "color-primary-3",
    desc: "Güvenli veri erişimi, rol bazlı yetki ve entegrasyon ihtiyaçları baştan planlandığında ürün büyümeye hazır olur.",
  },
  {
    id: 80,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-4.jpg",
    title: "Mobil Uygulama Fikrini Ürün Kapsamına Dönüştürmek",
    date: "15 Mayıs 2026",
    category: "Mobil",
    colorClass: "color-primary-4",
    desc: "Kullanıcı yolculuğu, bildirim senaryoları ve offline ihtiyaçlar netleştiğinde mobil ürün daha kontrollü çıkar.",
  },
  {
    id: 81,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-5.jpg",
    title: "Eski Sistemleri Modernize Etmeden Önce Bakılması Gerekenler",
    date: "19 Mayıs 2026",
    category: "Modernizasyon",
    colorClass: "color-primary-1",
    desc: "Performans, güvenlik, entegrasyon ve bakım maliyeti birlikte değerlendirildiğinde doğru modernizasyon planı ortaya çıkar.",
  },
  {
    id: 82,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-6.jpg",
    title: "Yazılım Projesinde Teslimat Ritmi Nasıl Kurulur?",
    date: "21 Mayıs 2026",
    category: "Teslimat",
    colorClass: "color-primary-2",
    desc: "Net kapsam, önceliklendirme ve düzenli geri bildirim döngüsü projenin hem hızını hem kalitesini artırır.",
  },
  {
    id: 83,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-7.jpg",
    title: "Veri Güvenliği Ürün Tasarımının Neresinde Başlar?",
    date: "21 Mayıs 2026",
    category: "Güvenlik",
    colorClass: "color-primary-3",
    desc: "Yetkilendirme, erişim denetimi ve kayıt izleri geliştirme sürecinin başında ele alındığında riskler azalır.",
  },
  {
    id: 84,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-8.jpg",
    title: "Teknokent Kültürüyle Ürün Geliştirme Disiplini",
    date: "21 Mayıs 2026",
    category: "Ar-Ge",
    colorClass: "color-primary-4",
    desc: "Ar-Ge yaklaşımı, teknik fizibilite ve hızlı prototipleme birleştiğinde fikirler daha sağlıklı ürüne dönüşür.",
  },
];
...
export const widgetPosts = [
  {
    id: 85,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-1-gemu.png",
    title: "Kurumsal web başlangıç kriterleri",
    author: "Gemu Technology",
  },
  {
    id: 86,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-2-gemu.png",
    title: "AI ve otomasyon kullanım alanları",
    author: "Gemu Technology",
  },
  {
    id: 87,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-3.jpg",
    title: "Ölçeklenebilir süreç tasarımı",
    author: "Gemu Technology",
  },
  {
    id: 88,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-4.jpg",
    title: "Mobil ürün kapsamı",
    author: "Gemu Technology",
  },
  {
    id: 89,
    imgUrl: "/assets/images/demo-corporate/blog/post-prev-5.jpg",
    title: "Modernizasyon öncesi kontrol",
    author: "Gemu Technology",
  },
];
